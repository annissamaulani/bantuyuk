...
class Laporan extends CI_Controller {
    ...
    public function index(){
        ...
        $this->load->view('admin/Laporan/laporanPage');
    }
    ...
    public function harian() {
        ...
        $lapor = $this->MdlAdminLaporan->getAllTransaksiHari($tgl_transaksi)->result();
    ...
    public function bulanan() {
        ...
        $lapor = $this->MdlAdminLaporan->getAllTransaksiBulan($bulan)->result();
